...
export default async function handler(req, res) {
  ...
  const backendBase = String(process.env.SHARE_PROXY_BACKEND_BASE_URL || 'https://be.locsang.vn').replace(/\/+$/, '');
  ...
  const requestHost = normalizeHeaderValue(req.headers['x-forwarded-host'] || req.headers.host, 'locsang.vn');
